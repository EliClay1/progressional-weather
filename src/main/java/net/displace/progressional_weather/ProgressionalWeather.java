...
@Mod(ProgressionalWeather.MODID)
public class ProgressionalWeather {
    public static final String MODID = "progressional_weather";
    ...
    public static final DeferredBlock<Block> EXAMPLE_BLOCK = BLOCKS
            .registerSimpleBlock("example_block", p -> p.mapColor(MapColor.STONE));
    ...
    public static final DeferredItem<Item> EXAMPLE_ITEM = ITEMS
            .registerSimpleItem("example_item", p -> p.food(new FoodProperties.Builder()
    ...
    public ProgressionalWeather(IEventBus modEventBus, ModContainer modContainer) {
